...
In this example, we transform the Wikipedia URIs, defined in another resource , to DBpedia URIs. We can use this `` elsewhere as an object. (e.g., to create *sameAs* links) 
